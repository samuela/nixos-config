...
let
  ...
  # Tracking nixpkgs master branch. Last updated 2026-04-17.
  unstable-nixpkgs-src = builtins.fetchTarball "https://github.com/NixOS/nixpkgs/archive/3e73265ba7d6f615477628fff4607c27e65020b1.tar.gz";
